...
DEVICE_SRCS = \
	c_src/device/device_ops.c

FONT_SRCS = \
	c_src/font/font.c \
	c_src/font/ops/font_ops.c

IMAGE_SRCS = \
	c_src/image/image.c \
	c_src/image/ops/image_ops.c
...
ifeq ($(SCENIC_LOCAL_TARGET),glfw)
	...
	DEVICE_SRCS += \
		c_src/device/glfw_device_ops.c \
		c_src/nanovg/nanovg.c
	FONT_SRCS += c_src/font/ops/nvg_font_ops.c
	IMAGE_SRCS += c_src/image/ops/nvg_image_ops.c
